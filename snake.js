...
class Game {
  ...
  constructor(width, height, amount) {
    ...
    this.height = height;
    this.amount = amount;
    //llamamos a las funciones para comenzar el jeugo junto al canvas
    //al canvas se le pasan el width y height para su forma
  ...
  initCanvas(width, height) {
    ...
    //Damos los valores introducidos al canvas
    canvas.width = width;
    canvas.height = height;
    //Añadimos borde al canvas para que se vea
    canvas.style.border = "3px solid";
    //Añadimos el canvas en primer elemento de body, por eso el [0]
